VCENTER="pksvc.newstack.local"
VC_ADMIN="administrator@pksvc.local"
VC_PASS="Osmium76!"
VC_DATACENTER="pksdemo"
# VC_NETWORK="VM"
...
#VMW does not want master to be schedulable
...
CLUSTER_UUID="dev-k8s-cluser-1874"
echo "
[Global]
